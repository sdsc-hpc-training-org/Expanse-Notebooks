...
{::nomarkdown}
{% assign jupyter_path = "assets/jupyter/Dask_Graph_CPU/dask_graphs_CPU.ipynb" | relative_url %}
{% capture notebook_exists %}{% file_exists assets/jupyter/Dask_Graph_CPU/dask_graphs_CPU.ipynb %}{% endcapture %}
