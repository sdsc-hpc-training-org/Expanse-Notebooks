...
{::nomarkdown}
{% assign jupyter_path = "assets/jupyter/CIML_2025/4-4/openai-api.ipynb" | relative_url %}
{% capture notebook_exists %}{% file_exists assets/jupyter/CIML_2025/4-4/openai-api.ipynb %}{% endcapture %}
...
{::nomarkdown}
{% assign jupyter_path = "assets/jupyter/CIML_2025/4-4/RAG_Solution.ipynb" | relative_url %}
{% capture notebook_exists %}{% file_exists assets/jupyter/CIML_2025/4-4/RAG_Solution.ipynb %}{% endcapture %}
{% if notebook_exists == "true" %}
{% jupyter_notebook jupyter_path %}
{% else %}
